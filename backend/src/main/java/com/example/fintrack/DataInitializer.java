...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Bill bill7 = new Bill();
        bill7.setName("Water");
        bill7.setDate(ZonedDateTime.now().minusDays(1).minusHours(18));
