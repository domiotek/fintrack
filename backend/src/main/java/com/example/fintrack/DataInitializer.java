...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        bill3.setAmount(BigDecimal.valueOf(125));
        Bill bill4 = new Bill();
        ...
        Bill bill8 = new Bill();
        bill8.setName("Woda");
        bill8.setDate(ZonedDateTime.now().minusDays(1).minusHours(18));
        ...
        billRepository.saveAll(List.of(bill1, bill2, bill3, bill4, bill5, bill6, bill7, bill8));
    }
}
